    ...
    return (
        <div className="page-container">
            ...
            <header className="header-section animate-in">
                ...
                <div className="header-info">
                    ...
                    <div className="header-links">
                        ...
                        <a href="mailto:abhinav.malkoochi@gmail.com" className="header-link">
                        ...
                        <a href="/resume.pdf" target="_blank" className="header-link">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <section className="about-section animate-in delay-1">
                <p className="about-text">CS Graduate from UT Dallas</p>
            </section>
                    ...
                    {projects.map((project) => (
                        ...
                        >
                            <Link
                                ...
                                className="grow py-4 sm:py-5 pr-2 sm:pr-8 flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-4 cursor-pointer"
                            >
                                ...
                                <div className="flex gap-1.5 sm:gap-2 shrink-0 sm:w-40 sm:justify-end flex-wrap">
                                    {project.tech.map((t) => (
